...
public interface ConfigurationServiceConstants {
  ...
  String PLAYLIST_CONTAINER_COLUMNS_SET_NODE = PLAYLIST_CONTAINER_NODE + ".columns";
  String PLAYLIST_CONTAINER_COLUMN_NODE = PLAYLIST_CONTAINER_COLUMNS_SET_NODE + ".column";
